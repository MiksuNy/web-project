...
export default function MobilePanel() {
  ...
  return (
    <div className="md:hidden fixed flex justify-evenly z-100 bottom-0 w-screen bg-background select-none pb-2 border shadow-2xl">
      <Link to="/" className="flex flex-col items-center p-2 cursor-pointer active:text-green-600">
      ...
      <Link to="/messages" className="flex flex-col items-center p-2 cursor-pointer active:text-green-600">
